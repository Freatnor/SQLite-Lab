...
SELECT name, population, code FROM country WHERE region = 'Southern Europe' GROUP BY population HAVING min(population);
Holy See?
...
SELECT countrycode FROM countrylanguage WHERE percentage = 100 AND language = 'Italian';
SMR - San Marino
...
SELECT name, id FROM city WHERE countrycode = 'SMR' AND name NOT LIKE 'San Marino';
Serravalle|3170
...
Serra|BRA
SELECT name, code FROM country WHERE code = 'BRA';
Brazil|BRA
